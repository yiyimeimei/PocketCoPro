...
public class Camera2Control implements ICameraControl {
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Objects.requireNonNull(manager).openCamera(cameraId, deviceStateCallback, backgroundHandler);
    ...
    private final Comparator<Size> sizeComparator = (lhs, rhs) -> Long.signum((long) lhs.getWidth() * lhs.getHeight() - (long) rhs.getWidth() * rhs.getHeight());
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : Objects.requireNonNull(manager).getCameraIdList()) {
                ...
                Objects.requireNonNull(windowManager).getDefaultDisplay().getSize(screenSize);
