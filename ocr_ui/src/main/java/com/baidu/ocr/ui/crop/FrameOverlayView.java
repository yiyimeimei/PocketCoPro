...
public class FrameOverlayView extends View {
    ...
    private void drawCorners(Canvas canvas) {
        ...
        // left top
        drawLine(canvas, frameRect.left - cornerLineWidth / 2.0f, frameRect.top, cornerLength, 0);
        drawLine(canvas, frameRect.left, frameRect.top, 0, cornerLength);

        // right top
        drawLine(canvas, frameRect.right + cornerLineWidth / 2.0f, frameRect.top, -cornerLength, 0);
        ...
        drawLine(canvas, frameRect.right + cornerLineWidth / 2.0f, frameRect.bottom, -cornerLength, 0);

        // left bottom
        drawLine(canvas, frameRect.left - cornerLineWidth / 2.0f, frameRect.bottom, cornerLength, 0);
