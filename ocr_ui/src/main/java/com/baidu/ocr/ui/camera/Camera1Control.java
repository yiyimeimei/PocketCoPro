...
public class Camera1Control implements ICameraControl {
     ...
     * 非扫描模式
     */
    private final int MODEL_NO_SCAN = 0;
    ...
    private int detectType = MODEL_NO_SCAN;
    ...
    private final Comparator<Camera.Size> sizeComparator = (lhs, rhs) -> Long.signum((long) lhs.width * lhs.height - (long) rhs.width * rhs.height);
