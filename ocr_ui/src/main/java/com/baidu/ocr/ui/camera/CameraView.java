...
public class CameraView extends FrameLayout {
    ...
    private int detect(byte[] data, final int rotation) {
        ...
        int width = rotation % 180 == 0 ? Objects.requireNonNull(decoder).getWidth() : Objects.requireNonNull(decoder).getHeight();
        int height = rotation % 180 == 0 ? Objects.requireNonNull(decoder).getHeight() : Objects.requireNonNull(decoder).getWidth();
